...
public interface ID3v2 extends ID3v1 {
  ...
  void addImage(byte[] image, String mimeType, byte imageType, String imageDescription);
  ...
  // TPE3 - Conductor/performer refinement - Dirigent
  String getConductorRefinement();

  void setConductorRefinement(String conductor);

  // TIT3 - Subtitle/description refinement - Titelzusatz
