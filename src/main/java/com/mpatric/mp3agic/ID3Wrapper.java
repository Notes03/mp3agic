...
public record ID3Wrapper(ID3v1 id3v1Tag, ID3v2 id3v2Tag) {

	public String getTrack() {
		if (id3v2Tag != null && id3v2Tag.getTrack() != null && !id3v2Tag.getTrack().isEmpty()) {
	...
	public List<String> getArtistList() {
		if (id3v2Tag != null && id3v2Tag.getArtistList() != null && !id3v2Tag.getArtistList().isEmpty()) {
