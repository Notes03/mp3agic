...
public class MpegFrameTest {
  ...
  public void shouldExtractValidMpegVersion1Header() throws InvalidDataException {
    ...
    assertTrue(mpegFrame.isProtection());
    assertTrue(mpegFrame.hasPadding());
    assertFalse(mpegFrame.isPrivate());
    assertFalse(mpegFrame.isCopyright());
    assertFalse(mpegFrame.isOriginal());
